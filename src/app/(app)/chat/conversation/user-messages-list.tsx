...
export function UserMessagesList() {
	return (
		<div className="flex flex-row-reverse gap-2">
			<Avatar className="size-8 rounded-lg">
				<AvatarImage src="https://api.dicebear.com/9.x/thumbs/png?seed=Mathews" alt="@shadcn" />
				...
				<ul role="list" className="space-y-2">
					{messages.map((message) => {
						return (
							<li
								key={message.id}
								className="bg-primary/20 w-full max-w-[420px] space-y-1 rounded-md p-2 first:rounded-tr-none"
							>
